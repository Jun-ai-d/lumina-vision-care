        ...
        <section id="ourdoctor" className="py-20 relative overflow-hidden bg-mesh-soft">
            ...
            <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 lg:gap-20 items-center relative z-10">
                ...
                >
                    ...
                    <div className="relative aspect-[4/5] overflow-hidden rounded-[2.5rem] shadow-2xl z-10">
                        <Image
                ...
                >
                    <div>
                        ...
                        <h2 className="text-3xl md:text-4xl font-serif font-bold text-primary-900 mb-5 leading-tight">
                    ...
                    <div className="pt-3">
                        <a
                            ...
                            className="inline-flex items-center gap-2 px-10 py-5 bg-primary-900 text-white font-bold rounded-full hover:bg-primary-700 transition-all duration-300 shadow-[0_8px_30px_rgba(2,42,53,0.3)] hover:shadow-[0_12px_40px_rgba(2,42,53,0.45)] hover:-translate-y-1 active:translate-y-0"
